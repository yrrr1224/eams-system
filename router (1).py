...
from com.wanhe.course.vo import (
...
from com.wanhe.auth.auth_deps import get_current_user, require_teacher
...
def add_course(data: CourseCreate, user = Depends(require_teacher)):
    ...
    new_id = CourseModel().add(data.name, data.credit, data.teacher_id)
